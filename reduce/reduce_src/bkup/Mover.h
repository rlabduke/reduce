...
//		   delete i->second;
   ...
   virtual int makebumpers(std::multimap<LocBlk, BumperPoint*>& bbins, NeighborList<BumperPoint*>& sym_bblks,
...
//void bondedList(const PDBrec& a, std::list< std::pair<PDBrec*, Point3d> >& nearby, int nbnds,

...
//	void CollectBumping(const AtomDescr& ad, std::list<PDBrec*>& bumping);
   ...
   void init_neighborList(scitbx::af::double6 cell, char* space_grp, Coord distance_cutoff){
	_sym_neighbor_list=NeighborList<PDBrec*>(cell, space_grp, distance_cutoff);
   }

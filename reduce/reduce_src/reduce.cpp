...
#if USE_SYM
typedef std::pair<PDBrec*, Point3d> RecPoint;
#else
typedef PDBrec* RecPoint;
#endif
...
void recordSkipInfo(bool skipH, std::vector<std::string>& fixNotes,
   ...
   std::list<RecPoint>& nearr, const char * msg);
...
// okToPlaceHydHere() in sym/nosym subdirs

// recordSkipInfo() in sym/nosym subdirs
